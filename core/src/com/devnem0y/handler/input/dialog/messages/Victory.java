...
public class Victory extends Dialog {

    private Texture label;

    public Victory(int width, int height, String leader, String text, int align, boolean onExit, Stage stage) {
        super(width, height, leader, text, align, onExit, stage);
        label = new Texture("image/victory.png");
    }
